...
# Ajoutez les noms des colonnes au DataFrame
X_train_sc = pd.DataFrame(X_train_sc, columns=elements_)
...
#
MLPR_m.feature_names_in_ = elements_
X_train.columns = elements_
mapie3 = MapieRegressor(MLPR_m, method="base", cv="prefit")
